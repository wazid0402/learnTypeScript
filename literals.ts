...
//example1:- 
let Datatest: string | number = "Hello" // this is not litrerals as we are using types.
let Data1: "abc" | "123" = "abc" // this is literals.
let Data2: "abc" | "123" = "123" // this is literals.
